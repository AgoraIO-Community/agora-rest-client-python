...
class TestClient:
    ...
    def test_build_error_region(self):
        with pytest.raises(exceptions.ClientBuildException) as e:
            client = Client \
                .new_builder() \
                .with_app_id(self._app_id) \
    ...
    def test_call_api_error_timeout(self, mocker):
        ...
        assert e.value.error_msg == "Function do_http_request (args=('GET', '/')) (kwargs={'params': None, 'post_data': None, 'post_json': None, 'headers': None, 'timeout_seconds': 5, 'trace_id': None}) timed out after 2.000000 seconds.\n"
